...
class App extends React.Component {
  render(){
    return (
      <div>
        <NavBar title="React Gmail Style client" user="manassuri52@gmail.com" />
        <MainContainer />
      </div>
    )
  }
  ...
  render() {
    ...
    return (
      <nav className="navbar navbar-toggleable-md navbar-inverse bg-inverse">
        ...
        <img className="nav-logo" src="https://avatars1.githubusercontent.com/u/49301320?s=460&v=4" width="36" height="36" />
